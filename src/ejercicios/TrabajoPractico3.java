...
public class TrabajoPractico3 {
    ...
    /**
     * Pedido 1 Cliente 2 Detalles de PEdidos * 1 Mercaderia * Cantidad
     *
     * @return Pedido
     */
    ...
    public Pedido ejercicio3() {
        Pedido pedido2 = this.ejercicio2();
        
        Mercaderia mercaderiaNueva = new Mercaderia();
        mercaderiaNueva.setCodigo("COD003");
        mercaderiaNueva.setNombre("Leche en Polvo");
        mercaderiaNueva.setPeso(1);
